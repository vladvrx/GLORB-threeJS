...
The recovered glorb island — original Three.js r150 engine, hashed GLBs, intro boat, LETS GO, dialogue, Cove, neon water. Phone and map stay removed.
...
- Survival / restore-the-island loop that already exists on Cove (quests, systems, pickups)
