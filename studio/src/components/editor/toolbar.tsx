    ...
    <header className="flex flex-wrap items-center gap-2 border-b border-white/10 bg-[#061821] px-3 py-2">
      ...
      <div className="ml-auto flex flex-wrap items-center gap-1">
        ...
        <Button
          ...
          onClick={() => {
            exportGamePack();
            toast.success("Downloaded GLORB JSON pack");
          }}
        >
          <Download className="size-3.5" />
          Game pack
        ...
        <Button
          ...
          onClick={async () => {
            ...
            try {
              ...
              toast.success("Applied Island West and the paint square — opening the game");
        ...
        <Button
          ...
          onClick={async () => {
            await resetToBundle();
            toast.message("Restored Island West and the paint square");
          }}
        >
