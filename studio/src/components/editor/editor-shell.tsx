  ...
  if (status === "loading") {
    return (
      <div className="grid h-dvh place-items-center bg-[#061821] px-6 text-center text-teal-50">
        <div>
          <p className="text-lg font-semibold">Loading Island West and the paint square…</p>
          <p className="mt-2 text-sm text-teal-200/70">Those are the only maps you can edit.</p>
        </div>
      </div>
    );
  }
