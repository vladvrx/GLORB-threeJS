...
5. **Jump** with Space or the small button in the bottom-right. The default hop is a small tuck; press **1** for `jump1`, the wide star-jump. Jumps float a bit (lower gravity) so they go higher.
